<?php
	...
	function getcats(){
		...
		while ($row_cats=mysqli_fetch_array($run_cats) ){
			...
			echo "<li class='btn-block'><a class='dots' href='index.php?cat-id=$cat_id'>$cat_title</a></li>";
					...
					<div class='col-md-10 text-center' style='padding:0;'>
			            <div class='card'>
			            	...
			            	<div class='card-body text-white'>
			            		<img class='card-img-top' alt='Some laptops' src='admin/admin_images/$pro_image' style='height:40%; width:50%;' '>
				          	</div><p class='text-danger'>$$pro_price</p><b>$pro_desc</b>
			             	<div class='card-footer text-center text-white'>
			             		
			             		<a href='index.php?pro_id=$pro_id' class='card-link'><span><i class='fas fa-reply'></i></span></a>
...
<body>
	...
	<footer class="container-fluid text-white" style="margin-top: 30px; background-color: black; padding:30px;">
		...
		<div class="container-fluid text-center text-white" style="font-family: damn;">
			<div class="row">
				<div class="col">
