			            ...
			            <div class='card'>
			            	...
			            	<div class='card-body text-white'>
			             	...
			             	<div class='card-footer text-center text-white'>
			             		...
			             		<a href='index.php?add_cart=$pro_id' class='card-link'><input type='button' name='BUY NOW' value='Addtocart'></a>
			             	</div>
			            </div>
			        </div>
				";
...
<body>
	...
	<div class="main">
		...
		<div class="container-fluid text-center">
			<div class="row">
				<div class="col-md-2">
					<div class="nav nav-pills text-left nav-stacked" id="cats">
		...
		<div class="container-fluid text-center text-white">
			<div class="row">
				<div class="col">
					...
					<i class="fab fa-facebook-square" style="font-size:30px; color:blue; padding: 10px; text-shadow:2px 2px 4px #000000;"></i>
					<i class="fab fa-git-square" style="font-size:30px; color:green; padding: 10px; text-shadow:2px 2px 4px #000000;"></i>
					<i class="fab fa-google-play" style="font-size:30px; color:gold; padding: 10px; text-shadow:2px 2px 4px #000000;"></i>
					<i class="fab fa-instagram" style="font-size:30px; color:pink; padding: 10px; text-shadow:2px 2px 4px #000000;"></i>
					<i class="fab fa-linkedin" style="font-size:30px; color:blue; padding: 10px; text-shadow:2px 2px 4px #000000;"></i>
					<br>
